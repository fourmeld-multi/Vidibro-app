...
export default function PenFightPage() {
  ...
  function resetRound() {
    ...
    const off = isLS ? 30 : 55;
    g.p1 = mkP(w / 2 + (Math.random() - 0.5) * (w * 0.20), tableBotY - off + (Math.random() - 0.5) * 20, (Math.random() - 0.5) * 0.5);
    g.p2 = mkP(w / 2 + (Math.random() - 0.5) * (w * 0.20), tableTopY + off + (Math.random() - 0.5) * 20, (Math.random() - 0.5) * 0.5);
