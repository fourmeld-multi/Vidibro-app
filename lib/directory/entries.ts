...
export const ENTRIES: DirectoryEntry[] = [
...

  {
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Free random video chat with Delhi strangers — no signup",
        body: "Random video chat Delhi connects you live with people from Delhi NCR — Connaught Place, Hauz Khas, Noida, Gurgaon. No account, no app, no download. Chat in Hindi, Punjabi or English, 1-on-1 and free. Works on Jio, Airtel and BSNL.",
      },
      {
        kind: "culture",
        title: "A capital of people from everywhere in India",
        body: "Delhi's population has been shaped by decades of arrivals for work and study from Bihar, UP, Punjab and the north-east. Asking 'where are you originally from' is completely normal here and usually leads into a real story rather than small talk.",
      },
      {
        kind: "culture",
        title: "University capital — DU, JNU, Jamia and more",
        body: "Delhi has one of the largest concentrations of students in India, with Delhi University, JNU and Jamia Millia Islamia all in the city. That student population shapes when people are online, what they talk about, and the city's reputation as a place of opinions and debate.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat Delhi connects you instantly with strangers from Delhi NCR — no signup, no app, no account. Chat in Hindi, Punjabi or English, 1-on-1 and free. Works on Jio, Airtel and BSNL across Delhi, Noida, Gurgaon and Faridabad.",
      "Delhi is a city of arrivals — most people here moved for university or work from Bihar, UP, Punjab and the north-east. Asking where someone is from is completely normal and usually leads into a real conversation rather than small talk.",
      "The large student population shapes when people are online: Delhi's queue fills from around 21:30 IST and stays busy until 1am. Hindi and English switch freely, Punjabi is common, and Urdu is still spoken in parts of the old city.",
      "No registration, no download, no coins. Calls run peer-to-peer directly between browsers on any device and are never recorded.",
    ],
    faqs: [
      { question: "How do I start free random video chat in Delhi?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with someone from Delhi NCR — no signup, no download, no account needed." },
      { question: "What language will people in Delhi speak?", answer: "Hindi and English, usually interchangeably. Punjabi is common, and Urdu is still spoken in parts of the old city. Most people switch to whichever language you prefer." },
      { question: "Does it work across NCR — Noida, Gurgaon, Faridabad?", answer: "Yes. There is no location filter, so the whole NCR is part of the same pool along with the rest of India. Works on Jio, Airtel and BSNL." },
      { question: "When is Delhi busiest on random video chat?", answer: "From about 21:30 to 01:00 IST. The large student population means it picks up earlier than Mumbai and quietens slightly sooner." },
      { question: "Is registration required?", answer: "No. No account, no phone number, no email. Open the page and you are in the queue instantly." },
      { question: "Can I switch to voice or text instead?", answer: "Yes, any time. Voice runs with the camera off and text needs neither camera nor microphone. All three match from the same pool." },
    ],
    related: [
      { slug: "video-chat-mumbai", label: "random chat Mumbai", relation: "city" },
      { slug: "video-chat-kolkata", label: "random chat Kolkata", relation: "city" },
      { slug: "video-chat-bangalore", label: "random chat Bangalore", relation: "city" },
      { slug: "hindi-video-chat", label: "Hindi video chat", relation: "language" },
      { slug: "urdu-video-chat", label: "Urdu video chat", relation: "language" },
...

  {
    ...
    weight: 1.4,
    hideWhatIs: true,
    providers: ["Jio", "Airtel", "BSNL", "Dialog (Sri Lanka)", "SingTel (Singapore)"],
    tagline:
      "Free Tamil video chat — no account, no app, no filter. 80 million speakers across India, Sri Lanka, Singapore and Malaysia. Start instantly.",
    spotlights: [
      {
        kind: "culture",
        title: "Kollywood — a star system that owes nothing to Bollywood",
        body: "Rajinikanth, Kamal Haasan, Vijay, Ajith Kumar — Kollywood has its own box-office records, its own fan culture and its own rivalries, entirely independent of Bollywood. Asking someone which side they are on is one of the fastest ways into a real conversation with a Tamil speaker.",
      },
      {
        kind: "culture",
        title: "A classical language with a two-thousand-year literary tradition",
        body: "Tamil is one of the world's oldest continuously spoken languages and holds classical language status in India. Speakers are genuinely proud of this — not performatively, but in the way you are proud of something you grew up with. Showing even passing curiosity about it lands well.",
      },
      {
        kind: "diaspora",
        title: "Official in three countries, spoken across six",
        body: "Tamil holds official status in India, Sri Lanka and Singapore, with large established communities in Malaysia, the Gulf and the UK. A conversation on Vidibro is as likely to reach Jaffna or Kuala Lumpur as Chennai — and the regional varieties are audibly distinct enough for people to place each other in seconds.",
      },
      {
        kind: "culture",
        title: "Filter coffee is not a beverage, it is a ritual",
        body: "South Indian filter coffee — brewed in a traditional davara, poured from height to cool and froth — is a subject Tamil speakers have strong opinions about. How it is made, where to get the best cup, and whether the technique is negotiable (it is not) makes for a longer conversation than you might expect.",
      },
    ],
    quickFacts: [
      { emoji: "🌍", title: "Speakers", body: "80M+ across 4 countries" },
      { emoji: "🎬", title: "Kollywood", body: "2nd largest film industry in India by output" },
      { emoji: "🕐", title: "Peak hours", body: "21:00–00:30 IST" },
      { emoji: "📚", title: "Language age", body: "2,000+ yr literary history" },
      { emoji: "🌐", title: "Diaspora", body: "SG, MY, UK, Gulf, CA" },
    ],
    localPhrases: [
      { phrase: "வணக்கம்!", meaning: "Hello", say: "Vanakkam" },
      { phrase: "சூப்பர்!", meaning: "Great / awesome — borrowed but everywhere", say: "Super" },
    ],
    starters: [
      {
        topic: "Kollywood",
        ask: "Which side are you on — Rajini or Kamal?",
        why: "A rivalry that has existed for decades with no neutrals — everyone has an answer.",
      },
      {
        topic: "Where they are",
        ask: "Chennai, Jaffna, Singapore or somewhere else entirely?",
        why: "Tamil is official in three countries. The answer tells you which variety you are hearing.",
      },
    ],
    reviews: [
      {
        ...
        text: "I have been trying to improve my Tamil for two years. Vidibro is the only place I have found where people are actually patient with a beginner who makes mistakes. Voice chat especially — no pressure.",
      },
      {
        name: "Priya N.",
        flag: "🇸🇬",
        role: "Tamil diaspora, Singapore",
        text: "Growing up in Singapore you lose the language slowly. This brought it back. I have spoken more Tamil in the last month than in the last five years. And half in Tanglish, which everyone here accepts.",
      },
      {
        name: "Arjun V.",
        flag: "🇮🇳",
        role: "Kollywood fan",
        text: "Came for the random chats, stayed because I found someone who argued for forty minutes about which Rajini film is the best. Nobody in my office cares about this. Very happy.",
      },
      {
        name: "Dilshan P.",
        flag: "🇱🇰",
        role: "Sri Lankan Tamil",
        text: "It is rare to find a platform where Jaffna Tamil speakers and Chennai Tamil speakers end up talking. The differences come up naturally and it never gets awkward — usually just curious questions back and forth.",
      },
    ],
    places: ["Chennai", "Coimbatore", "Madurai", "Jaffna", "Singapore", "Kuala Lumpur"],
    talkingPoints: [
      "Kollywood — its own star system, its own box-office records, and rivalries that go back decades with no neutrals",
      "Tamil as a classical language with a two-thousand-year literary tradition speakers are genuinely proud of",
      "Pongal in January — a harvest festival that matters more here than most north Indian festivals",
      "Filter coffee and the correct way to make and pour it, which is not up for debate",
      "The diaspora — Tamil communities in Singapore, Malaysia, Sri Lanka, the Gulf and the UK are long-established and active",
    ],
    connectivityNote:
      "Tamil speakers span four countries with very different networks — Indian users on Jio or Airtel 4G/5G, Sri Lankan users on Dialog or Mobitel, Singapore and Malaysia on some of the fastest mobile networks anywhere. Vidibro adapts video quality to whichever end is slower.",
    localNote:
      "Tamil is one of the few languages with official status in multiple countries: India, Sri Lanka and Singapore. Speakers from Jaffna, Chennai and Singapore sound audibly different within a sentence or two — the regional variety is usually a conversation starter rather than a barrier.",
    safetyNote:
      "Tamil conversations reach Sri Lanka, Singapore and Malaysia as well as India. Be careful with questions about the Sri Lankan civil war and its aftermath — for Tamil speakers from Sri Lanka this is living memory, not history.",
    etiquette:
      "Tamil speakers are notably proud of the language's age and literature, and curiosity about it lands far better than polite small talk. Assuming a Tamil speaker also speaks Hindi is a reliable way to end a conversation.",
    intro: [
      "Tamil has around 80 million speakers with an unusual distribution — it holds official status in India, Sri Lanka and Singapore, with large established communities in Malaysia, the Gulf and the UK. A Tamil conversation on Vidibro is as likely to reach Jaffna or Kuala Lumpur as Chennai.",
      "It is also among the oldest continuously spoken languages in the world, with a literary tradition going back two thousand years. That is not background noise — it is something speakers bring up, and showing genuine interest lands far better than routine small talk.",
      "Regional varieties differ enough that people can usually place each other within a few sentences. Chennai Tamil, Madurai Tamil and Jaffna Tamil are all audibly distinct, and the differences themselves are a reliable conversation opener rather than a barrier.",
      "There is no language filter, so this page describes what to expect rather than guaranteeing it. No account, nothing installed, nothing recorded — peer-to-peer across Jio, Airtel, Dialog and SingTel.",
    ],
    faqs: [
      { question: "Can I find Tamil speakers on random video chat?", answer: "Regularly, particularly during the Indian evening peak (21:00–00:30 IST). There is no language filter, so no individual match is guaranteed, but with around 80 million speakers across four countries Tamil comes up often." },
      { question: "Will I reach someone from Tamil Nadu or Sri Lanka?", answer: "Either is possible, and Singapore or Malaysia too. Tamil is official in three countries and there is no country filter, so the range is wider than most language pages." },
      { question: "Is Tamil video chat free?", answer: "Yes, completely. No account, no subscription, no credits. A browser on any device is all you need — works on Jio, Airtel, BSNL, Dialog and SingTel." },
      { question: "Can I use Tanglish instead of pure Tamil script?", answer: "Yes. Tanglish — Tamil words written in English letters — is widely used and fully accepted on Vidibro. Nobody will correct you for it." },
      { question: "Can I practise Tamil with strangers?", answer: "Many people use it exactly for this. Voice chat suits language practice well — camera off, less pressure. Most Tamil speakers are patient with learners who make a genuine effort." },
      { question: "What is the best time for Tamil conversations?", answer: "21:00 to 00:30 IST for Indian and Sri Lankan users. Singapore and Malaysia are 2.5 hours ahead, so their evening overlaps with the earlier part of that window." },
      { question: "Is it safe?", answer: "The usual rules apply: no full name, no address, no financial details. Calls are peer-to-peer and never recorded. The report button ends a conversation immediately." },
    ],
    related: [
      { slug: "video-chat-chennai", label: "random chat Chennai", relation: "city" },
      { slug: "video-chat-coimbatore", label: "random chat Coimbatore", relation: "city" },
      { slug: "video-chat-bangalore", label: "random chat Bangalore", relation: "city" },
      { slug: "video-chat-india", label: "random chat India", relation: "sibling" },
      { slug: "video-chat-sri-lanka", label: "random chat Sri Lanka", relation: "sibling" },
      { slug: "hindi-video-chat", label: "Hindi video chat", relation: "language" },
      { slug: "malayalam-video-chat", label: "Malayalam video chat", relation: "language" },
      { slug: "random-voice-chat", label: "Tamil voice chat", relation: "mode" },
      { slug: "anonymous-text-chat", label: "Tamil text chat", relation: "mode" },
      { slug: "omegle-alternative", label: "Omegle alternatives", relation: "competitor" },
    ],
  },
...

  {
    ...
    kind: "country",
    name: "Russia",
    primaryKeyword: "random video chat Russia",
    title: "Random Video Chat Russia — Free, Talk to Russian Strangers",
    description:
      "Free random video chat Russia — talk to Russian strangers live, 1-on-1, no signup. Meet people from Moscow and St Petersburg instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet Russian strangers from Moscow to St Petersburg — free, no signup",
        body: "Random video chat Russia connects you live with people from Moscow, St Petersburg, Novosibirsk and Yekaterinburg. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real Russian stranger for a free 1-on-1 video call.",
      },
      {
        kind: "culture",
        title: "One of the largest random chat markets in Europe",
        body: "Russia has unusually cheap and fast mobile internet on MTS, Beeline and Megafon, a highly online population, and long winters that keep people indoors for months. The queue here is reliably busy in a way smaller European markets are not — active from 21:00 to 01:00 MSK.",
      },
      {
        kind: "culture",
        title: "Best free Omegle alternative for Russian random chat",
        body: "Since Omegle shut down, millions in Russia have been looking for a free random video chat alternative with no registration and no coins. Vidibro is 100% free, peer-to-peer and anonymous — just click and talk to Russian strangers on MTS, Beeline or Megafon.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat Russia connects you instantly with Russian strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere in Russia. Meet people from Moscow, St Petersburg, Novosibirsk or Yekaterinburg, completely free.",
      "Russia is one of the largest random chat markets in Europe, with cheap fast internet on MTS, Beeline and Megafon, a highly online population, and long winters that keep people indoors for months. The queue here is reliably busy from 21:00 to 01:00 MSK every night.",
      "Russian is spoken by essentially everyone. English proficiency is lower than in Northern or Western Europe — younger users in Moscow and St Petersburg often speak it well, but outside the two capitals Russian is the default. The lack of smiling is cultural, not cold — warmth arrives a few minutes in and tends to be genuine.",
      "No registration, no coins, no premium tier. Calls run peer-to-peer directly between browsers and are never recorded.",
    ],
    faqs: [
      { question: "How do I start free random video chat with Russian strangers?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real Russian stranger — no signup, no download, no account on either side." },
      { question: "Do people in Russia speak English?", answer: "Younger users in Moscow and St Petersburg often do. Outside the two capitals it is much less common, and Russian is the default with a stranger." },
      { question: "When is Russia's random video chat busiest?", answer: "From about 21:00 to 01:00 MSK. The country spans eleven time zones but the queue follows Moscow and St Petersburg where most people are." },
      ...
      { question: "Is Vidibro a good Omegle alternative for Russia?", answer: "Yes. Free, no registration, works on any device, peer-to-peer 1-on-1 video chat. Works on MTS, Beeline and Megafon with no coins or premium tier needed." },
      { question: "Is it free?", answer: "Completely — no account, no subscription, no credits, no premium tier." },
    ],
    related: [
      { slug: "video-chat-moscow", label: "random chat Moscow", relation: "city" },
      { slug: "video-chat-saint-petersburg", label: "random chat St Petersburg", relation: "city" },
      { slug: "video-chat-novosibirsk", label: "random chat Novosibirsk", relation: "city" },
      { slug: "russian-video-chat", label: "Russian chat", relation: "language" },
      { slug: "turkish-video-chat", label: "Turkish chat", relation: "language" },
      { slug: "random-voice-chat", label: "random voice chat", relation: "mode" },
      { slug: "text-chat", label: "random text chat", relation: "mode" },
      { slug: "omegle-alternative", label: "Omegle alternatives", relation: "competitor" },
      { slug: "video-chat-turkey", label: "random chat Turkey", relation: "sibling" },
      { slug: "video-chat-germany", label: "random chat Germany", relation: "sibling" },
    ],
  },
...

  {
    ...
    title: "Random Video Chat UK — Free, Talk to British Strangers",
    description:
      "Free random video chat UK — talk to British strangers live, 1-on-1, no signup. Meet people from London, Manchester and Glasgow instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet British strangers from London to Glasgow — free, no signup",
        body: "Random video chat UK connects you live with people from London, Manchester, Birmingham, Glasgow, Leeds and Liverpool. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real British stranger for a free 1-on-1 video call.",
      },
      {
        kind: "culture",
        title: "Four nations — England, Scotland, Wales, Northern Ireland",
        body: "The UK is genuinely four nations, each with distinct accents, culture and identity. Assuming everyone is English is a common and mildly irritating mistake. Scotland, Wales and Northern Ireland each have their own character — worth asking which nation someone is from.",
      },
      {
        kind: "culture",
        title: "Best free Omegle alternative for UK random chat",
        body: "Since Omegle shut down, millions in the UK have been looking for a free random video chat alternative with no signup and no coins. Vidibro is 100% free, peer-to-peer and anonymous — just click and talk to British strangers on EE, O2, Vodafone or Three.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat UK connects you instantly with British strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere across the UK. Meet people from London, Manchester, Birmingham, Glasgow or Leeds, completely free.",
      "The UK runs on a single time zone, which keeps the evening chat peak sharp and predictable — from around 21:00 to 01:00 GMT, without the rolling window a country like the US needs. Strong 4G and 5G on EE, O2, Vodafone and Three in cities keeps video quality solid.",
      "It is genuinely four nations rather than one — England, Scotland, Wales and Northern Ireland each have distinct accents and identity. Assuming everyone is English is a common, mildly irritating mistake. Football is the fastest route into a real conversation: which club someone supports reliably opens up more than any generic opener.",
      "No registration, no coins, no premium tier. Calls run peer-to-peer directly between browsers and are never recorded.",
    ],
    faqs: [
      { question: "How do I start free random video chat with British strangers?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real UK stranger — no signup, no download, no account on either side." },
      { question: "Is random video chat UK really free with no signup?", answer: "Yes — completely free, no account, no email, no coins, no premium tier. Works on EE, O2, Vodafone and Three without any registration." },
      { question: "Will I meet people from London or Manchester?", answer: "Both are possible — the queue pulls from across the whole UK. London and Manchester are the most common sources, but every match is genuinely random." },
      ...
      { question: "Is Vidibro a good Omegle alternative for UK random chat?", answer: "Yes. Free, no registration, works on any device, peer-to-peer 1-on-1 video chat — the same instant anonymous experience Omegle offered, now working on EE, O2, Vodafone and Three." },
      { question: "Is it free?", answer: "Completely — no account, no subscription, no credits, no premium tier." },
    ],
    related: [
      { slug: "video-chat-london", label: "random chat London", relation: "city" },
      { slug: "video-chat-manchester", label: "random chat Manchester", relation: "city" },
      { slug: "video-chat-glasgow", label: "random chat Glasgow", relation: "city" },
      { slug: "english-video-chat", label: "English chat", relation: "language" },
      ...
      { slug: "video-chat-poland", label: "random chat Poland", relation: "sibling" },
    ],
  },
...

  {
    ...
    title: "Random Video Chat France — Free, Talk to French Strangers",
    description:
      "Free random video chat France — talk to French strangers live, 1-on-1, no signup. Meet people from Paris, Lyon and Marseille instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet French strangers from Paris to Marseille — free, no signup",
        body: "Random video chat France connects you live with people from Paris, Lyon, Marseille, Toulouse, Nice and Bordeaux. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real French stranger for a free 1-on-1 video call.",
      },
      {
        kind: "culture",
        title: "French is much bigger than France",
        body: "French is spoken natively across Belgium, Switzerland, Quebec and much of West Africa — over 300 million speakers worldwide. A match from this queue could be from any of those places, and conversations about where French fits in their life usually go somewhere real. Café culture and an unhurried approach to conversation are distinctly French hallmarks worth knowing before you start.",
      },
      {
        kind: "culture",
        title: "Best free Omegle alternative for French random chat",
        body: "Since Omegle shut down, millions in France have been looking for a free random video chat alternative with no registration and no coins. Vidibro is 100% free, peer-to-peer and anonymous — just click and talk to French strangers on Orange, SFR, Bouygues or Free.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat France connects you instantly with French strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere in France. Meet people from Paris, Lyon, Marseille, Toulouse or Nice, completely free.",
      "France runs on a later daily rhythm than most of Europe — dinner at 8pm and evenings that run well past midnight. The chat queue here peaks from 20:00 to midnight CET, later than the UK or Germany, and conversations tend to be longer and more relaxed as a result.",
      "A simple 'bonjour' before starting goes a long way — skipping straight into a question reads as abrupt here. French directness including open disagreement is a normal register, not rudeness. Works on Orange, SFR, Bouygues and Free with solid 4G across all major cities.",
      "No registration, no coins, no premium tier. Calls run peer-to-peer directly between browsers and are never recorded.",
    ],
    faqs: [
      { question: "How do I start free random video chat with French strangers?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real French stranger — no signup, no download, no account needed." },
      { question: "Will people in France speak English?", answer: "Often in cities and among younger people, but French is the safer default expectation. A simple 'bonjour' before diving in is genuinely appreciated." },
      { question: "When is France's random video chat busiest?", answer: "Roughly 20:00 to midnight CET — later than most of Europe, reflecting France's later daily rhythm." },
      { question: "Is Vidibro a good Omegle alternative for France?", answer: "Yes. Free, no registration, works on any device, peer-to-peer 1-on-1 video chat. Works on Orange, SFR, Bouygues and Free with no coins or premium tier needed." },
      { question: "Do I need to speak French to chat with French strangers?", answer: "No — many French people, especially younger users in cities, speak English. That said, starting with 'bonjour' is genuinely appreciated and goes a long way even if you switch to English right after." },
      { question: "Is it free?", answer: "Completely — no account, no subscription, no credits, no premium tier." },
    ],
    related: [
      { slug: "video-chat-paris", label: "random chat Paris", relation: "city" },
      { slug: "video-chat-marseille", label: "random chat Marseille", relation: "city" },
      { slug: "video-chat-lyon", label: "random chat Lyon", relation: "city" },
...

  {
    ...
    kind: "country",
    name: "Spain",
    primaryKeyword: "random video chat Spain",
    title: "Random Video Chat Spain — Free, Talk to Spanish Strangers",
    description:
      "Free random video chat Spain — talk to Spanish strangers live, 1-on-1, no signup. Meet people from Madrid, Barcelona and Valencia instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet Spanish strangers from Madrid to Barcelona — free, no signup",
        body: "Random video chat Spain connects you live with people from Madrid, Barcelona, Valencia, Seville and Bilbao. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real Spanish stranger for a free 1-on-1 video call.",
      },
      {
        kind: "time",
        title: "Latest chat peak in Europe — dinner at 10pm",
        body: "Spain runs on Central European Time despite sitting roughly in line with the UK geographically. The practical result is a daily rhythm that runs much later — dinner at 9 or 10pm and a chat queue that peaks past midnight, later than almost any other European country.",
      },
      {
        kind: "culture",
        title: "Best free Omegle alternative for Spanish random chat",
        body: "Since Omegle shut down, millions in Spain have been looking for a free random video chat alternative with no signup and no coins. Vidibro is 100% free, peer-to-peer and anonymous — just click and talk to Spanish strangers on Movistar, Orange or Vodafone.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat Spain connects you instantly with Spanish strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere in Spain. Meet people from Madrid, Barcelona, Valencia, Seville or Bilbao, completely free.",
      "Spain runs on Central European Time despite its geography, pushing daily life later than almost anywhere else in Europe — dinner at 9 or 10pm and the chat queue peaking from 22:00 to 02:00 CET. Works on Movistar, Orange and Vodafone with strong 4G across major cities.",
      "Regional identity runs deep — Catalan is a distinct living language spoken across Catalonia, and Basque identity carries its own real weight. Football is the fastest conversation starter: the Real Madrid-Barcelona rivalry carries genuine regional and political charge beyond the sport.",
      "No registration, no coins, no premium tier. Calls run peer-to-peer directly between browsers and are never recorded.",
    ],
    faqs: [
      { question: "How do I start free random video chat with Spanish strangers?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real Spanish stranger — no signup, no download, no account needed." },
      { question: "Why does Spain's random video chat peak so late?", answer: "Spain runs on Central European Time despite its geography, pushing dinner, socialising and the chat queue later than almost anywhere else in Europe — commonly past 10pm, peaking from 22:00 to 02:00 CET." },
      { question: "Will I meet people from Madrid or Barcelona?", answer: "Both are possible — the queue pulls from across Spain. Every match is genuinely random with no location filter." },
      { question: "Is Catalan just a Spanish dialect?", answer: "No — Catalan is a distinct Romance language, spoken natively across Catalonia and used in schools, media and government there." },
      { question: "Is Vidibro a good Omegle alternative for Spain?", answer: "Yes. Free, no registration, works on any device, peer-to-peer 1-on-1 video chat. Works on Movistar, Orange and Vodafone with no coins or premium tier needed." },
      { question: "Is it free?", answer: "Completely — no account, no subscription, no credits, no premium tier." },
    ],
    related: [
      { slug: "video-chat-madrid", label: "random chat Madrid", relation: "city" },
      { slug: "video-chat-barcelona", label: "random chat Barcelona", relation: "city" },
      { slug: "video-chat-valencia", label: "random chat Valencia", relation: "city" },
      { slug: "spanish-video-chat", label: "Spanish chat", relation: "language" },
...

  {
    ...
    title: "Random Video Chat Canada — Free, Talk to Canadians",
    description:
      "Free random video chat Canada — talk to Canadian strangers live, 1-on-1, no signup. Meet people from Toronto, Vancouver and Montreal instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet Canadians from Toronto to Vancouver — free, no signup",
        body: "Random video chat Canada connects you live with people from Toronto, Vancouver, Montreal, Calgary and Ottawa. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real Canadian stranger for a free 1-on-1 video call.",
      },
      {
        kind: "culture",
        title: "Bilingual country — English and French",
        body: "French is the primary daily language for millions of Canadians, especially in Quebec — a lived reality rather than a symbolic second language. Canada is genuinely bilingual, so the stranger you meet could open in either language, and switching is normal.",
      },
      {
        kind: "culture",
        title: "Best free Omegle alternative for Canadian random chat",
        body: "Since Omegle shut down, Canadians have been looking for a free alternative with no signup and no coins. Vidibro is 100% free, peer-to-peer, and anonymous — just click and talk to Canadian strangers instantly. Works on Rogers, Bell and Telus with no download needed.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat Canada connects you instantly with Canadian strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere across Canada. Meet people from Toronto, Vancouver, Montreal, Calgary or Ottawa, completely free.",
      "Canada is genuinely bilingual: French is the primary daily language for millions of Canadians, especially in Quebec, and the stranger you match with could open in French, English or switch between both. There is no language filter, so every conversation is genuinely random.",
      "Canadian random video chat runs on Rogers, Bell and Telus — strong 4G and growing 5G in major cities. The queue is busiest from 20:00 to midnight Eastern Time, when Toronto and Vancouver are both online. Six time zones means there is almost always someone available.",
      "No registration, no coins, no premium tier. Calls run peer-to-peer directly between browsers and are never recorded. Skip any conversation and get matched again — instant, free, anonymous.",
    ],
    faqs: [
      { question: "How do I start free random video chat with Canadians?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real Canadian stranger — no signup, no download, no account on either side." },
      { question: "Is Canadian random video chat really free with no signup?", answer: "Yes — completely free, no account, no email, no coins, no premium tier. Every feature works without registration on Rogers, Bell or Telus." },
      { question: "Will I meet people from Toronto or Vancouver?", answer: "Both are possible — Canada's population is concentrated in Eastern and Pacific zones, so Toronto and Vancouver are the most common matches. Every match is genuinely random." },
      { question: "Is Canada bilingual for video chat?", answer: "Yes, genuinely — French is the primary daily language for millions of Canadians, especially in Quebec. You may be matched with French or English speakers, or people who switch between both." },
      { question: "Is Vidibro a good Omegle alternative for Canada?", answer: "Yes. Free, no registration, works on any device, peer-to-peer 1-on-1 video chat — the same instant anonymous experience Omegle offered, now working on Rogers, Bell and Telus." },
      { question: "Is it free?", answer: "Completely — no account, no subscription, no credits, no premium tier." },
    ],
    related: [
      { slug: "video-chat-toronto", label: "random chat Toronto", relation: "city" },
      { slug: "video-chat-vancouver", label: "random chat Vancouver", relation: "city" },
      { slug: "video-chat-montreal", label: "random chat Montreal", relation: "city" },
      { slug: "english-video-chat", label: "English chat", relation: "language" },
      { slug: "french-video-chat", label: "French chat", relation: "language" },
      { slug: "random-voice-chat", label: "random voice chat", relation: "mode" },
      { slug: "text-chat", label: "random text chat", relation: "mode" },
      { slug: "omegle-alternative", label: "Omegle alternatives", relation: "competitor" },
      { slug: "video-chat-united-states", label: "random chat United States", relation: "sibling" },
      { slug: "video-chat-france", label: "random chat France", relation: "sibling" },
    ],
  },
...

  {
    ...
    title: "Random Video Chat USA — Free, No Signup | Talk to Americans",
    description:
      "Free random video chat USA — talk to American strangers live, 1-on-1, no signup, no download. Meet people from New York, LA and Chicago instantly.",
    hideWhatIs: true,
    tagline:
    ...
    spotlights: [
      {
        kind: "culture",
        title: "Meet Americans from New York to California — free, no signup",
        body: "Random video chat USA connects you live with people from across all fifty states — New York, Los Angeles, Chicago, Houston, Atlanta, Seattle. No registration, no app, no account. Open your browser, press start, and you are matched instantly with a real American stranger.",
      },
      {
        kind: "time",
        title: "Four time zones — always someone online",
        body: "The US spans four mainland time zones, so American random video chat stays active for longer than any other single country. The queue fills from the east coast at 21:00 ET and stays busy until California winds down around 02:00 ET — a three-hour rolling peak every night.",
      },
      {
        kind: "culture",
        title: "The best free Omegle alternative for US chat",
        body: "Since Omegle shut down, millions of Americans moved to free random video chat alternatives. Vidibro is 100% free, no coins, no premium tier, no registration on either side. Just click and talk — 1-on-1 live video chat with American strangers, anonymous and instant.",
      },
    ],
    localPhrases: [
    ...
    intro: [
      "Random video chat USA connects you instantly with American strangers — no signup, no app, no account. Just open your browser, press start, and you are live 1-on-1 with a real person from somewhere across the United States. It works on any device, and every call is completely free.",
      "The United States is the largest English-speaking market for free random video chat, with people online around the clock across all fifty states. New York, Los Angeles, Chicago, Houston, Atlanta — the queue pulls from the whole country, so the person you meet could be anywhere from the east coast to the west.",
      "Because the US spans four mainland time zones, American random video chat stays busy longer than any other single country. The peak rolls from 21:00 ET when the east coast comes online, and California keeps the queue active until around 02:00 ET. There is almost always someone to talk to.",
      "No registration, no phone number, nothing to install. Calls run peer-to-peer directly between browsers and are never recorded. Skip any conversation instantly and get matched again — no cooldown, no cost, no account needed.",
    ],
    faqs: [
      { question: "How do I start a free random video chat with Americans?", answer: "Open Vidibro in your browser, choose Video Chat, and press Start. You are matched instantly with a real American stranger — no signup, no download, no account on either side." },
      { question: "Is American random video chat really free with no signup?", answer: "Yes — completely free, no account, no email, no coins, no premium tier. Every feature works without registration. Your browser is all you need." },
      { question: "What is the best time for US random video chat?", answer: "From about 21:00 to 02:00 ET. The US covers four time zones so the peak rolls westward — the east coast fills the queue first, and California keeps it active until the early hours." },
      { question: "Will I reach people from New York or California?", answer: "Both are possible — the queue pulls from across all fifty states. There is no location filter, so every match is genuinely random." },
      { question: "Is Vidibro a good Omegle alternative for US chat?", answer: "Yes. Vidibro is free with no registration, works on any device, and connects you 1-on-1 with random strangers. No coins, no premium tier, no app needed — the same instant anonymous video chat Omegle offered." },
      { question: "Will people speak Spanish too?", answer: "Frequently. Spanish is the second language of the US with over 40 million speakers, and you will encounter it regularly in the queue." },
      { question: "Is it safe?", answer: "Calls are peer-to-peer and never recorded. Keep identifying details to yourself, never move to another app at a stranger's suggestion, and use the report button to end any conversation that feels wrong." },
    ],
    related: [
      { slug: "video-chat-new-york", label: "random chat New York", relation: "city" },
      { slug: "video-chat-los-angeles", label: "random chat Los Angeles", relation: "city" },
      { slug: "video-chat-chicago", label: "random chat Chicago", relation: "city" },
      { slug: "spanish-video-chat", label: "Spanish chat", relation: "language" },
      { slug: "english-video-chat", label: "English chat", relation: "language" },
      { slug: "random-voice-chat", label: "random voice chat", relation: "mode" },
      { slug: "text-chat", label: "random text chat", relation: "mode" },
      { slug: "omegle-alternative", label: "Omegle alternatives", relation: "competitor" },
      { slug: "video-chat-canada", label: "random chat Canada", relation: "sibling" },
      { slug: "video-chat-mexico", label: "random chat Mexico", relation: "sibling" },
      { slug: "video-chat-brazil", label: "random chat Brazil", relation: "sibling" },
    ],
  },
