...
const ko: NativeLangData = {
  ...
  description:
    "Vidibro — 무료 영상채팅·화상채팅 사이트. 회원가입 없이 랜덤 영상통화 즉시 시작. 랜덤 화상채팅으로 전 세계 낯선 사람과 1대1 실시간 대화. 계정 불필요, 완전 무료.",
  h1: "무료 영상채팅 — 랜덤 화상채팅 사이트",
  tagline: "가입 불필요. 랜덤 영상통화로 전 세계 낯선 사람과 지금 바로 대화하세요.",
  intro:
    "Vidibro는 계정 등록 없이 완전 무료로 이용할 수 있는 랜덤 화상채팅 사이트입니다. 무료 영상채팅·음성 통화·텍스트 채팅 세 가지 모드를 제공하며, 스마트폰과 PC 모두 브라우저에서 랜덤 영상통화를 바로 시작할 수 있습니다. 전 세계 180개국 이상의 사용자와 실시간으로 연결되며, 개인 정보는 일절 저장되지 않습니다. 무료 화상채팅으로 K-팝, K-드라마, 게임, 한국 음식 등 공통 관심사로 자연스럽게 대화를 시작해보세요.",
  btnVideo: "영상 채팅 시작",
  btnVoice: "음성 채팅",
  btnText: "텍스트 채팅",
