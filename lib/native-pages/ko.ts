...
const ko: NativeLangData = {
  ...
  tagline: "가입 불필요. 랜덤 영상통화로 전 세계 낯선 사람과 지금 바로 대화하세요.",
  intro:
    "Vidibro는 계정 등록 없이 완전 무료로 이용할 수 있는 랜덤 화상채팅 사이트입니다. 무료 영상채팅·음성 통화·텍스트 채팅 세 가지 모드를 제공하며, 스마트폰과 PC 모두 브라우저에서 랜덤 영상통화를 바로 시작할 수 있습니다. 전 세계 180개국 이상의 사용자와 실시간으로 연결되며, 개인 정보는 일절 저장되지 않습니다. 2026년 현재 가장 빠르게 성장하는 무료 랜덤 영통 사이트로, K-팝, K-드라마, 게임, 한국 음식 등 공통 관심사로 자연스럽게 대화를 시작해보세요.",
  btnVideo: "영상 채팅 시작",
  btnVoice: "음성 채팅",
  btnText: "텍스트 채팅",
  ...
  faqTitle: "자주 묻는 질문",
  faqs: [
    { question: "무료 영상채팅 사이트인가요?", answer: "네, Vidibro는 완전히 무료인 영상채팅 사이트입니다. 계정 생성도 필요 없고 신용카드 등록도 전혀 필요하지 않습니다." },
    ...
    { question: "한국어 사용자와 연결될 수 있나요?", answer: "언어 필터는 없지만 저녁 피크 시간대(19:00–00:00 KST)에는 한국어 사용자와 연결될 가능성이 높습니다." },
    { question: "화상채팅 대화는 녹음·저장되나요?", answer: "아니요. P2P 연결이므로 서버에 데이터가 전송되지 않으며 화상채팅 대화 기록도 일절 저장되지 않습니다." },
    { question: "랜덤영통 사이트 중 가장 안전한 곳은?", answer: "Vidibro는 P2P 연결로 서버에 영상이 저장되지 않으며, 계정 정보도 일절 수집하지 않아 안전하게 랜덤영통을 즐길 수 있습니다." },
    { question: "오메글 대안 중 한국어를 지원하는 사이트는?", answer: "Vidibro는 한국어 인터페이스를 완벽하게 지원하는 오메글 대안 사이트입니다. 가입 없이 무료로 랜덤 영상통화를 즐길 수 있으며, 한국 사용자 수가 빠르게 증가하고 있습니다." },
  ],
