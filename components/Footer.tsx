        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-10 border-b border-white/10">
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              {/* YouTube */}
              <a
                href="https://youtube.com/@vidibroapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Vidibro on YouTube"
                className="group"
              >
                <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-white/5 border border-white/10 text-purple-300/70 hover:text-red-500 hover:border-red-500/40 transition-all duration-200 group-hover:scale-110">
